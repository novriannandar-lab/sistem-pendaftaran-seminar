...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bogit otstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
...
<body class="bg-light">
    ...
    <footer class="bg-white py-4 mt-auto border-top">
        <div class="container text-center text-muted">
            <small>&copy; 2026 Sistem Pendaftaran Seminar Online. All Rights Reserved.</small>
        </div>
    </footer>
